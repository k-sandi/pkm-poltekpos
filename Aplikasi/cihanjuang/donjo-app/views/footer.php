			<footer class="main-footer">
				...
				<strong>Aplikasi <a href="https://github.com/OpenSID/OpenSID" target="_blank"> OpenSID</a>, modify by <a href="http://poltekpos.ac.id" target="_blank">PKM Poltekpos</a>.</strong>
			</footer>
		</div>
